                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  class="alert alert-success" style="text-align: right;"><?= ($fila->puntos*$fila->entrada)?></td>
                                ...
                                <? 
                                   $total_puntos = $total_puntos + ($fila->puntos*$fila->entrada);
                        ...
                        <table class="table table-striped table-bordered table-hover" >
                           <thead>
                                <tr>
                                    ...
                                    <th class="alert alert-success" colspan="2">Total Puntos</th>
                                ...
                                <tr>
                                    ...
                                    <th class="alert alert-success" colspan="2"><?= $total_puntos ?></th>
